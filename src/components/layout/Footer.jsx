    ...
    <>
      <footer className="bg-surface-container border-t border-secondary/30 w-full mt-stack-lg">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-stack-lg grid grid-cols-1 md:grid-cols-4 gap-gutter">
          ...
          <div>
            <h4 className="font-semibold text-primary text-xs tracking-wider mb-6">Connect</h4>
            <ul className="space-y-3">
              <li><a className="text-on-surface-variant hover:text-secondary transition-colors" href="#">Instagram</a></li>
              <li><a className="text-on-surface-variant hover:text-secondary transition-colors" href="#">LinkedIn</a></li>
              <li><Link className="text-on-surface-variant hover:text-secondary transition-colors" to="/book-appointment">Contact Us</Link></li>
            </ul>
          </div>
        </div>
